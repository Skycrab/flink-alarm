...
public class HttpUtil {
    ...
    private static String doGet(String urlPath, Map<String, String> params) {
        return doGet(urlPath, Charsets.UTF_8, params, (Map)null);
    }

    private static String doGet(String urlPath, Map<String, String> params, Map<String, String> headers) {
        return doGet(urlPath, Charsets.UTF_8, params, headers);
    }

    private static String doGet(String urlPath, Charset charset, Map<String, String> params, Map<String, String> headers) {
        ...
        try {
            ...
            if(e.getStatusCode() == 200) {
                ...
                LOGGER.warn("http get status code error,status {}", Integer.valueOf(e.getStatusCode()));
            }
    ...
    static {
        ...
        params.setMaxTotalConnections(64);
